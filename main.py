...
async def on_message(message):
	if ("Gil" not in message.author.name
	    and message.channel.id == "97b0c27c-aa0a-4c2a-9c42-414982d19506"):
...
@discordbot.event
async def on_message(message):
	if not message.author.bot and message.channel.id == 884525097677910033:
